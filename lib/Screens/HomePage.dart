                 ...
                 body:Stack(
                            children:<Widget>[
                                Container(
                                     ...
                                     image: NetworkImage("https://i.pinimg.com/236x/c0/68/99/c06899ac1992ed4eee31443d608dfad8--tron-legacy-cyberpunk.jpg"),
                                     fit: BoxFit.cover,                    
                                       ),
                                    ),
                                ),
                                ...
                                Positioned(
                                    ...
                                    child: ButtonTheme(
                                        ...
                                        height:50,
                                        child:FlatButton(
                                            child: Icon(sound? Icons.volume_up : Icons.volume_off, color: Color(0xff19817e),),
                                            onPressed: () {
                                                 player.play('http://ccmixter.org/content/Loveshadow/Loveshadow_-_SUPERPOWER_(feat_Siobhan_Dakay).mp3');
                                    ...
                                    child:Column(
                                            children:<Widget>[
                                                ButtonTheme(
                                                    ...
                                                    side: BorderSide(width:5.0, color:Color(0xff81b9da),),),
                                            ...
                                            ButtonTheme(
                                                    ...
                                                    side: BorderSide(width:5.0, color:Color(0xff81b9da),),),
                                                    textColor: Color(0xff81b9da),
                                                    child: Text("TUTORIAL",style: TextStyle(fontSize:40,),),
                                                    onPressed: (){},
                                                ),
                                            ),
                                            SizedBox(height: 20),
                                            ...
                                            ButtonTheme(
                                                    ...
                                                    side: BorderSide(width:5.0, color:Color(0xff81b9da),),),
                                                    textColor: Color(0xff81b9da),
                                                    child: Text("EXIT",style: TextStyle(fontSize:40,),),
                                                    onPressed: (){},
                                                ),
                                            ),
                                        ],
